...
public class StatefulClient {
    ...
    public static void main(String str[]) throws Exception {
        ...
        //   System.out.println("..invoking helloWorld("+parameterValues[0]+") ");
        System.out.println(wsm.invoke(parameterNames, parameterValues)); 
    
        wsm = wsp.getMethod("count"); 
        if (wsm == null)
            throw new NullPointerException("count() operation not available in this service");
     
        System.out.println(wsm.invoke(null, null));
        System.out.println(wsm.invoke(null, null));
        System.out.println(wsm.invoke(null, null)); 
